...
* [Вопрос для повторения](#questions)
...
# <a name="questions"></a>Вопрос для повторения
> Как предоставить доступ к сетевому устройству нескольким пользователям, у каждого из которых есть собственное имя пользователя?

Создать нового пользователя командой `username newuser privilege 15 secret password`