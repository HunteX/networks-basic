# Оглавление
1. [Схема стенда](#scheme)
1. [Часть 1. Настройка топологии и конфигурация основных параметров маршрутизатора и коммутатора](#part1)
1. [Часть 2. Ручная настройка IPv6-адресов](#part2)
1. [Часть 3. Проверка сквозного соединения](#part3)
1. [Вопросы для повторения](#questions)

# Схема стенда <a name="scheme"></a>
![](scheme.png)

# Часть 1. Настройка топологии и конфигурация основных параметров маршрутизатора и коммутатора <a name="part1"></a>
...
# Часть 2. Ручная настройка IPv6-адресов <a name="part2"></a>
...
# Часть 3. Проверка сквозного соединения <a name="part3"></a>
...
# Вопросы для повторения <a name="questions"></a>
